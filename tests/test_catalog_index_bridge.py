...
from planetarypy.catalog._index_resolver import (
    IndexConfig,
    INDEX_REGISTRY,
    get_index_config,
    has_index,
...
class TestResolveFromIndex:
    ...
    def test_with_mocked_index(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "planetarypy.catalog._index_resolver._load_index_df",
...
class TestExtraIndexKeys:
    ...
    def test_load_concatenates_multiple_indexes(self, monkeypatch):
        ...
        from planetarypy.catalog._index_resolver import _load_index_df
