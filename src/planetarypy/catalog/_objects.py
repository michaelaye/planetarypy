...
class Instrument:
    ...
    def product_types(self) -> list[str]:
        ...
        from planetarypy.catalog import list_product_types
        return list_product_types(self.mission, self.name)

    def product_type_details(self):
        """Product types with phase/format breakdown as a DataFrame."""
        from planetarypy.catalog import list_product_types
        return list_product_types(self.mission, self.name, include_phases=True)
